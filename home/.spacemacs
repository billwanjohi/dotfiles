...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; can't configure rg without RIPGREP_CONFIG_PATH variable
   ;; can't configure ag with anything other than bash aliases
